...
def get_analyzer_llm_response(user_prompt, primary_response):
    ...
    try:
        ...
        - Prompt Analysis: Evaluate the original prompt
        - Response Quality: Assess the primary LLM's response
        - Identified Issues: List any problems or limitations
        - Suggested Improvements: Provide specific recommendations
        - Refined Prompt: Offer an improved version of the prompt"""
